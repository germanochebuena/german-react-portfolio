      ...
      <section className={`py-20 px-4 relative overflow-hidden transition-all duration-1000 ${
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mt-8">
            <a href="mailto:info@germannochebuena.com" className="text-blue-600 hover:text-blue-800 font-medium">
              info@germannochebuena.com
            </a>
          ...
          <div className="grid md:grid-cols-3 gap-8 items-center">
            ...
            <div className="text-center">
              ...
              <div className="space-y-2">
                ...
                <a href="mailto:info@germannochebuena.com" className="block text-gray-400 hover:text-white transition-colors">
                  Contact
                </a>
              </div>
            </div>
            <div className="text-center md:text-right">
              ...
              <div className="flex justify-center md:justify-end space-x-4">
                ...
                <a href="mailto:info@germannochebuena.com" className="text-gray-400 hover:text-white transition-colors">
